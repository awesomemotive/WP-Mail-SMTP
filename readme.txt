...
Often bloggers and small business owners don't want to use third-party SMTP services. Well you can use your Gmail or GSuite account for SMTP emails.
...
= Can I use this plugin to send email via Gmail SMTP? =

Yes. You can use the Gmail SMTP option to set it up securely with our native integration, or choose Other SMTP and use these settings:
