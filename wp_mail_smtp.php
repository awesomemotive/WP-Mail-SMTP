...
if ( ! function_exists( 'wp_mail_smtp_options_page' ) ) :
	...
	function wp_mail_smtp_options_page() {
		...
		if (
			...
			__( 'Send Test', 'wp-mail-smtp' ) === $_POST['wpms_action'] &&
			is_email( $_POST['to'] )
		) {
			...
			<form method="post" action="options.php">
				...
				<table class="optiontable form-table">
					<tr valign="top">
						...
						<td>
							<fieldset>
								<legend class="screen-reader-text"><span><?php _e( 'Mailer', 'wp-mail-smtp' ); ?></span></legend>
								<p>
				...
				<table class="optiontable form-table">
					<tr valign="top">
						...
						<td>
							<fieldset>
								<legend class="screen-reader-text"><span><?php _e( 'Return Path', 'wp-mail-smtp' ); ?></span></legend>
